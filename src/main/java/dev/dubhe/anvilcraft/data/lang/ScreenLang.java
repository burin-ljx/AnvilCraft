...
public class ScreenLang {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("tooltip.anvilcraft.redstone_information.comparator.mode", "Mode: ");
        provider.add("tooltip.anvilcraft.redstone_information.comparator.mode_compare", "Compare");
        provider.add("tooltip.anvilcraft.redstone_information.comparator.mode_subtract", "Subtract");
